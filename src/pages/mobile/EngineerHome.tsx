      ...
      <div className="p-4 space-y-6">
                ...
                >
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <span className="text-sm text-gray-700">
                      {projectTasks.length}{" "}
                      {projectTasks.length === 1 ? "task" : "tasks"} today
                    </span>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button className="bg-white border border-gray-200 text-gray-700 rounded-lg p-4 flex flex-col items-center justify-center gap-2 active:bg-gray-50 transition-colors min-h-[100px]">
