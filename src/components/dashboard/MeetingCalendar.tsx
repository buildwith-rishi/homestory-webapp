...
interface MeetingCalendarProps {
  ...
  onUpdateMeeting: (meeting: CalendarMeeting) => void;
...
export const MeetingCalendar: React.FC<MeetingCalendarProps> = ({
  ...
  const events = useMemo(() => meetings, [meetings]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-7xl h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-orange-50 to-orange-100 flex-shrink-0">
          <div className="flex items-center gap-3">
        ...
        {/* Legend */}
        <div className="flex items-center gap-6 px-6 py-3 bg-gray-50 border-b border-gray-200 flex-shrink-0">
        ...
        {showAddModal && (
          <MeetingModal
            ...
            onSave={(meeting) =>
              onAddMeeting(meeting as Omit<CalendarMeeting, "id">)
            }
        ...
        {showEditModal && selectedMeeting && (
          <MeetingModal
            ...
            onSave={(meeting) => onUpdateMeeting(meeting as CalendarMeeting)}
            onDelete={() => {
