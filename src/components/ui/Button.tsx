...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      secondary:
        'bg-white text-secondary border-2 border-secondary hover:bg-secondary hover:text-white active:bg-[#1F0C00] disabled:border-ash disabled:text-ash disabled:opacity-50',
      ghost:
